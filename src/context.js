...
const AppProvider = ({ children }) => {
  ...
  const [data, setData] = React.useState([
    {
      name: "Bee", icon: '/bee2.png', letter: "E", type: GameTypes.multipleChoice, choices: { [t('beepage.choices.choise1')]: true, [t('beepage.choices.choise2')]: false },
    ...
    {
      name: "Butterfly", icon: '/butterfly2.png', type: GameTypes.text, letter: "M", answer: t("butterflypage.answer"), solved: false,
    ...
    {
      name: "Ladybug", icon: '/Ladybug2.png', type: GameTypes.number, letter: "B", answer: t("ladybugpage.answer"), solved: false,
    ...
    {
      name: "Slug", icon: '/Slug2.png', type: GameTypes.drag, letter: "R", choices: { 'choise1': true, 'choise2': false }, answer: t("slugpage.answer"),
    ...
    {
      name: "Chick", icon: '/Chick2.png', type: GameTypes.multipleChoice, choices: { [t('chickpage.choices.choise1')]: false, [t('chickpage.choices.choise2')]: true }, answer: t("chickpage.answer"),
    ...
    {
      name: "Plane", icon: '/Plane2.png', type: GameTypes.multipleChoice, letter: "O", choices: { [t('planepage.choices.choise1')]: false, [t('planepage.choices.choise2')]: true }, answer: t("planepage.answer"),
